...
<div class="bg-img">
  ...
  <table>
    ...
    <label for="BName"><b>Business Name </b></label><br>
    <input type="text" placeholder="Business Name" name="BName" id="BName" required><br>
...
<label for="phoneNo"><b>NIC No </b></label><br>
 <input type="text" placeholder="NIC No" name="nicNo" id="nicNo" required><br>
  ...
  <label for="email"><b>Email</b></label><br>
   ...
   <label for="BNo"><b>Business Registration No </b></label><br>
    <input type="text" placeholder="Business Registration No" name="BNo" id="BNo" required><br>
